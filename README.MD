...
## Changes from original gwfox

- Container label and icon are made visible in url field
- Star icon removed from url field made invisible
- Added color tint themes (ocean, forest, desert, cherry)
...
- Add `gwfox.atbc` to enable theme backgrounds or [Adaptive Tab Bar Colour](https://addons.mozilla.org/firefox/addon/adaptive-tab-bar-colour)
- Add `gwfox.bms` enable blur effects using [Blur my Shell](https://extensions.gnome.org/extension/3193/blur-my-shell)
- Add `gwfox.theme` with one of the following values to tint the theme `ocean`, `forest`, `desert`, `cherry`
